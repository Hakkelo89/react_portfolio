                    ...
                    <div className='col'>
                        <div className='card'>
                            ...
                            <div className='card-body'>
                                <div className="row">
                                    <p className='p-about'>
                                        Geophysical Engineer with a demonstrated history of working on construction projects. Deep
                            ...
                            <div className='card-body'>
                                ...
                                <div className='grid-container-profile'>
                                    <div className="grid-item">
                                        ...
                                        <div className='title-concentration'>Fullstack Developer Coding Bootcamp</div>
                                    </div>
                                    ...
                                    <div className="grid-item">
                                        ...
                                        <div className='title-concentration'>Bachelor of Geophysical Engineering</div>
                                    </div>
